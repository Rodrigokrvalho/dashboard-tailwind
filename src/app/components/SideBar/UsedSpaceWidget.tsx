  ...
  return (
    <div className="flex flex-col gap-4 rounded-lg bg-violet-50 px-4 py-5">
      ...
      <div className='space-x-3'>
        <button type='button' className="text-sm font-medium text-violet-500 hover:text-violet-700 transition-colors">Dismiss</button>
        <button type='button' className="text-sm font-medium text-violet-700 hover:text-violet-900 transition-colors">Upgrade plan</button>
      </div>
    </div>
  );
}